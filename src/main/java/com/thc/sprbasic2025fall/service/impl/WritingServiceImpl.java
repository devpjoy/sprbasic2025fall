...
@RequiredArgsConstructor // 알아서 필요한 constructor 만들어줌
@Service
public class WritingServiceImpl implements WritingService {

    final WritingRepository writingRepository;
    // 생성자 방식 (-> but @RequiredArgsConstructor라는 롬복이 대신 해줌)
    /* public WritingServiceImpl(WritingRepository writingRepository) { // 생성자 방식
    ...
    public Map<String, Object> create(Map<String, Object> params) {
        ...
        //writing.setId((long) id);
        writing.setTitle(title);
        writing.setContent(content);

        writingRepository.save(writing); // domain class로 만든 instance를 writing으로 저장
    ...
    public void update(Map<String, Object> params) {
        ...
        Writing writing = writingRepository.findById(id).orElse(null); // return type : Optional<> (혹시 null일 경우에 어떻게 할 건지 물어봄.)
        // orElse로 null 처리
